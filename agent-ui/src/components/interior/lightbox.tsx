  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={`absolute inset-0 overflow-hidden outline-none select-none focus-visible:ring-1 focus-visible:ring-inset focus-visible:ring-ring ${
      ...
      >
        <p
          id={titleId}
          className="pointer-events-auto max-w-[65%] truncate rounded-[9px] border border-border bg-background px-2.5 py-1.5 text-[12.5px] text-foreground"
        >
          {caption ?? alt}
        </p>
