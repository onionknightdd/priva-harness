...
export const en = {
  ...
  common: {
    ...
    copyCode: "Copy code",
    wrapCode: "Word wrap",
    enableCodeWrap: "Enable word wrap",
    disableCodeWrap: "Disable word wrap",
    copied: "Copied",
    copyFailed: "Unable to copy",
    codeWriting: "Writing",
    codeReady: "Ready",
    mermaidLoadFailed: "The diagram could not load. Source code is shown instead. Refresh the page to try again.",
    openLink: "Open link",
    expand: "Expand",
    collapse: "Collapse",
  },
  ...
  agentMessage: {
    ...
    mentionMenuLabel: "Project files",
    mentionEmpty: "No matching files",
    mentionLoading: "Loading files…",
    mentionFolderGroup: "Folder",
    ...
    workflowUI: {
      ...
      stages: "Workflow stages and agents",
      backToPhases: "Back to phases",
      openInWorkspace: "Open in Workspace",
      openAgent: "Open {{agent}} in Workspace",
      openFromMessage: "Open an agent from a workflow in the conversation.",
      thinking: "Reasoning",
      process: "Execution",
      ...
      loadFailed: "Full transcript is unavailable.",
      retry: "Retry",
      preview: "Preview · full content is not available yet",
      noContent: "No content available yet.",
      toolCalls: "{{count}} tool calls",
      attempt: "Attempt {{count}}",
      backToAgents: "Back to agents",
      unassigned: "Other agents",
      waiting: "Waiting for agents…",
      noMetrics: "Progress unavailable",
      noAgents: "No agents recorded for this stage.",
      unavailable: "Execution details are unavailable.",
      awaitingStages: "Waiting for workflow stages…",
      stats: "{{phases}} stages · {{agents}} agents",
    },
    taskPlan: "Task",
    ...
    toolItem: {
      ...
      imageGenDone: "Image",
      imageReadRunning: "Reading image",
      imageReadDone: "Image read",
      imageEditRunning: "Editing image",
      imageEditDone: "Image edit",
    ...
    imageTools: {
      inputPending: "Waiting for input…",
      loading: "Loading image…",
      loadFailed: "The image could not be loaded.",
      retryPreview: "Reload image",
      missingOutput: "No image file was returned.",
      ...
      compareValue: "Original image {{value}}% visible",
    },
    toolSummary: {
      separator: ", ",
  ...
  directoryPicker: {
    ...
    description: "Choose a folder for your new conversation.",
    path: "Directory path",
    ...
    noneSelected: "No directory selected",
    use: "Use directory",
  ...
  filePreview: {
    ...
    tooLargeTitle: "Content is too large to preview",
    tooLargeDescription: "Text previews are limited to 3 MiB. Download the file to view it.",
  ...
  sidebar: {
    ...
    modes: {
      ...
      agent: "Agent",
      code: "Code",
      help: "Compare Agent and Code",
      locked: "The mode is fixed when a session starts. Create a new chat to choose another mode.",
      comparison: {
        title: "Agent and Code",
        description: "Choose how Claude approaches your task. Chat and Terminal share the same mode.",
        dimension: "Compare",
        tasks: { label: "Best for", agent: "Everyday tasks, writing, research, and working with files", code: "Coding, debugging, and project development" },
        guidance: { label: "Instructions", agent: "General task instructions", code: "Claude Code instructions with platform guidance" },
        tools: { label: "Developer tools", agent: "No coding plan mode, Git worktrees, or structured code review", code: "Includes coding plan mode, Git worktrees, and structured code review" },
        resources: { label: "Capabilities", agent: "Files, commands, skills, MCP, and product tools", code: "Files, commands, skills, MCP, and product tools" },
        permissions: { label: "Permissions", agent: "Uses the current permission policy", code: "Uses the current permission policy" },
      },
    },
    groups: {
      project: "Project",
