  ...
  return (
    <motion.button
      ...
      className={cn(
        ...
        variant === "code"
          ? "-translate-y-px text-sky-600 underline decoration-sky-600/50 hover:decoration-sky-600 dark:text-sky-400 dark:decoration-sky-400/50 dark:hover:decoration-sky-400"
          : "hover:underline"
      )}
    >
      {showIcon ? (
